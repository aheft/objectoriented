...
set CLASSPATH=%APP_HOME%\lib\A1.jar;%APP_HOME%\lib\json-simple-1.1.1.jar;%APP_HOME%\lib\junit-4.10.jar;%APP_HOME%\lib\hamcrest-core-1.1.jar


@rem Execute A1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %A1_OPTS%  -classpath "%CLASSPATH%" rogue.A1Solution %*
